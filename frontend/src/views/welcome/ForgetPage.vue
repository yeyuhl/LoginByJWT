...
const rules = {
  // required表示必填，message表示验证失败时的提示信息，trigger表示触发验证的事件
  // blur是失去焦点时触发，change是值改变时触发
  // validator是自定义验证函数
  email: [
...
<template>
  <div>
    ...
    <!-- transition是过渡组件，name指定了过渡组件名称，这里是内置的一个名称，mode指定了过渡组件模式，这里是从外到内的淡入淡出 -->
        ...
        <div style="margin-top: 50px">
          <el-form :model="form" :rules="rules" @validate="onValidate" ref="formRef">
            ...
            <el-form-item prop="code">
              <!-- gutter用于设置同一行内不同列之间的间距 -->
              <el-row :gutter="10" style="width: 100%">
                <!-- span用于设置列占用的宽度，这里span为17，即该列将占用行宽度的17份 -->
                <el-col :span="17">
